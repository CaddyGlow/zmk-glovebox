...
"""
    ...
    def _generate_west_yml(
        ...
        """
        # Determine the correct ZMK repository based on keyboard
        if "glove80" in keyboard_profile.keyboard_name.lower():
            # Glove80 uses MoErgo's ZMK fork
...
"""
            ...
            # Standard ZMK repository for other keyboards
            west_yml_content = """# West configuration for ZMK - Generated by Glovebox
manifest:
  defaults:
    remote: zmkfirmware

...
def print_success_message(message: str, use_rich: bool = True) -> None:
...
def print_error_message(message: str, use_rich: bool = True) -> None:
...
def print_list_item(item: str, indent: int = 1, use_rich: bool = True) -> None:
...
def print_info_message(message: str, use_rich: bool = True) -> None:
...
def print_warning_message(message: str, use_rich: bool = True) -> None:
...
def print_header_panel(title: str, subtitle: str = "", icon: str = "") -> None:
    ...
    console = Console()
    panel = PanelStyles.create_header_panel(title, subtitle, icon)
    console.print(panel)
...
def print_device_table(devices: list[dict[str, Any]]) -> None:
    ...
    formatter.format_device_list(devices, "table")
...
def print_status_table(status_data: dict[str, Any]) -> None:
    ...
    console = Console()
    table = TableStyles.create_status_table()
...
def print_configuration_table(config_data: dict[str, Any]) -> None:

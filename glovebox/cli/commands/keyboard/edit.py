"""Keyboard configuration editing commands."""
...
def complete_keyboard_config_keys(incomplete: str) -> list[str]:
    """Tab completion for keyboard configuration keys."""
    try:
...
def _get_keyboard_field_type_for_key(config_key: str) -> type:
...
def edit_keyboard(
    ...
    keyboard_name: str = typer.Argument(
        ..., help="Keyboard name to edit", autocompletion=complete_keyboard_names
    ),
    get: Annotated[
        list[str] | None,
        typer.Option(
            ...
            autocompletion=complete_keyboard_config_keys,
        ),
    ] = None,
    set: Annotated[
        list[str] | None,
    ...
    if keyboard_name not in keyboards:
        print_error_message(f"Keyboard '{keyboard_name}' not found")
...
def _get_keyboard_config_value(keyboard_config: Any, key: str) -> Any:
...
def _handle_interactive_keyboard_edit(keyboard_name: str, app_ctx: AppContext) -> None:

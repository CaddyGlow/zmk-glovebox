...
{%- endif %}
    ...
    def test_cli_set_field_preserves_templates(self, cli_runner, template_layout_file):
        ...
        result = cli_runner.invoke(app, [
            "layout", "edit", str(template_layout_file),
            "--set", "version=2.0.0",
            "--output-format", "json"
        ])
        ...
        assert "{{ variables.timing.fast }}" in str(edited_data["holdTaps"][0]["tappingTermMs"])
        assert "{{ variables.user_name }}" in edited_data["custom_defined_behaviors"]

    def test_cli_edit_variables_preserves_templates(self, cli_runner, template_layout_file):
        """Test that editing variables via CLI preserves template references."""
        # Edit variable values via CLI
        result = cli_runner.invoke(app, [
            "layout", "edit", str(template_layout_file),
            "--set", "variables.user_name=EditedCLIUser",
            "--set", "variables.timing.fast=200",
            "--output-format", "json"
        ])
    ...
    def test_cli_multiple_operations_preserve_templates(self, cli_runner, template_layout_file):
        """Test multiple CLI operations in one command preserve templates."""
        # Multiple operations in one command
        result = cli_runner.invoke(app, [
            "layout", "edit", str(template_layout_file),
            "--set", "version=3.0.0",
            "--set", "variables.user_name=MultiOpUser",
            "--add-layer", "Functions",
            "--copy-layer", "QWERTY:QWERTYBackup",
            "--output-format", "json"
        ])
    ...
    def test_cli_add_template_field(self, cli_runner, template_layout_file):
        ...
        result = cli_runner.invoke(app, [
            "layout", "edit", str(template_layout_file),
            "--set", "variables.build_id=cli-test-123",
            "--set", "notes=User: {{ variables.user_name }}, Build: {{ variables.build_id }}",
            "--output-format", "json"
        ])
    ...
    def test_cli_edit_then_compile_workflow(self, cli_runner, template_layout_file, tmp_path):
        """Test complete workflow: CLI edit → compile with templates."""
        # Step 1: Edit via CLI
        result = cli_runner.invoke(app, [
            "layout", "edit", str(template_layout_file),
            "--set", "variables.user_name=CompileWorkflowUser", 
            "--set", "variables.timing.fast=250",
            "--output-format", "json"
        ])
        ...
        result = cli_runner.invoke(app, [
            "layout", "compile", str(template_layout_file),
    ...
    def test_cli_dry_run_preserves_templates(self, cli_runner, template_layout_file):
        ...
        result = cli_runner.invoke(app, [
            "layout", "edit", str(template_layout_file),
            "--set", "variables.user_name=DryRunUser",
            "--dry-run",
            "--output-format", "json"
        ])
    ...
    def test_cli_list_usage_shows_template_references(self, cli_runner, template_layout_file):
    ...
    def test_cli_error_handling_with_templates(self, mock_profile, cli_runner, template_layout_file):
        ...
        result = cli_runner.invoke(app, [
            "layout", "edit", str(template_layout_file),
            "--set", "title={{ variables.user_name }} - {{ variables.nonexistent | default('fallback') }}",
            "--output-format", "json"
        ])
        ...
        edited_data = json.loads(template_layout_file.read_text())
        assert "{{ variables.nonexistent | default('fallback') }}" in edited_data["title"]
...
class TestCLITemplateCompilationIntegration:
    ...
    def test_cli_compile_processes_templates(self, cli_runner, template_compilation_layout, tmp_path):
        ...
        result = cli_runner.invoke(app, [
            "layout", "compile", str(template_compilation_layout),
            "--output", str(output_path),
            "--profile", "planck"
        ])
    ...
    def test_cli_validate_with_templates(self, cli_runner, template_compilation_layout):
        ...
        result = cli_runner.invoke(app, [
            "layout", "validate", str(template_compilation_layout),
            "--output-format", "json"
        ])
    ...
    def test_cli_show_with_templates(self, cli_runner, template_compilation_layout):
        ...
        result = cli_runner.invoke(app, [
            "layout", "show", str(template_compilation_layout),
            "--output-format", "json"
        ])
    ...
    def test_cli_diff_with_templates(self, cli_runner, template_compilation_layout, tmp_path):
        ...
        # Diff the layouts
        result = cli_runner.invoke(app, [
            "layout", "diff", str(template_compilation_layout), str(modified_layout),
            "--output-format", "json"
        ])

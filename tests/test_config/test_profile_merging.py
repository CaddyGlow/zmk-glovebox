...
class TestKeyboardProfileMerging:
    ...
    def test_firmware_profile_kconfig_merging(
        ...
        assert "shared_option" in kconfig
        assert kconfig["shared_option"].default == "firmware_override"  # Not "keyboard_default"
        assert kconfig["shared_option"].description == "Option that overrides keyboard default"
    ...
    def test_firmware_config_empty_kconfig(
        self, base_keyboard_config: KeyboardConfig
    ):
